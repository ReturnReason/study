...
-- -- 
> 참고문서 <br> [W3C](www.w3.org) <br> [MDN 이벤트 버블링과 캡처링](https://developer.mozilla.org/ko/docs/Learn/JavaScript/Building_blocks/Events)
<br> [모던 자바스크립트 튜토리얼 - focus와 blur](https://ko.javascript.info/focus-blur) <br>
